...
const int lowweight = 8;          // Weight value to trigger event
const int highweight = 20;        // Weight value to not trigger event
const int triggercounter = 4;     // Weight trigger counter to delay spray event
const int spraytime = 200;        // Spary on time
